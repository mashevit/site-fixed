...
public interface SightseeingRepository extends JpaRepository<Sightseeing, Integer> {
		...
		List<Sightseeing> findBytripSightseeingsTripIdtripIn(List<Integer> id);
	...
	List<Sightseeing> findBycityIdcitiesIn(List<Integer> id);
	List<Sightseeing> findBycityIn(List<City> id);
