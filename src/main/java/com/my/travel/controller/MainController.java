...
//	}
	...
	public List<List<Trip>> frontTrips() {
		...
		if (a.size() < 3)
			return null;
		ans.add(tripRepository.findByCityIn(toArr(a.get(0))));
		ans.add(tripRepository.findByCityIn(toArr(a.get(1))));
		ans.add(tripRepository.findByCityIn(toArr(a.get(2))));

		return ans;
	}
	public List<City> toArr(City c){
		List<City> arrL = new ArrayList<>();
		arrL.add(c);
